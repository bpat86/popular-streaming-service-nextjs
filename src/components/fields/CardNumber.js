  ...
  return (
    <>
      <div className="relative">
        ...
        <label
          htmlFor="cardNumber"
          className="stripe-input-label pointer-events-none absolute top-0 bottom-0 flex h-14 origin-0 select-none items-center px-3 py-4 text-base font-medium text-gray-500 duration-300"
        >
          Card number
        </label>
        {errors.cardNumber && touched.cardNumber && errors.cardNumber && (
