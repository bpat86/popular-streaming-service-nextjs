    ...
    <>
      ...
      >
        {({
          ...
          <Form className="mt-2 w-full space-y-8">
              ...
              <div>
                ...
                submitting ? (
                  <button
                    disabled
                    type="submit"
                    className="mt-6 flex h-14 w-full items-center justify-center rounded-sm bg-red-800 py-3 px-4 text-base font-semibold tracking-wide text-white transition duration-700 ease-out focus:outline-none"
                  >
                    Processing
                    <svg
                  ...
                  <button
                    ...
                    type="submit"
                    className="mt-6 flex h-14 w-full items-center justify-center rounded-sm bg-netflix-red py-3 px-4 text-base font-semibold tracking-wide text-white transition duration-700 ease-out hover:bg-netflix-red-light focus:outline-none disabled:cursor-not-allowed disabled:bg-red-800"
                  >
                    Start Membership
                  </button>
                )}
