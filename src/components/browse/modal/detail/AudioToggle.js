  ...
  return (
    ...
    >
      ...
      {videoCanPlayThrough && !videoCompleted && (
        <button
          type="button"
          className={`relative ml-auto flex h-7 w-7 items-center justify-center rounded-full border-2 border-gray-400 bg-transparent font-bold text-gray-400 hover:border-white hover:text-white focus:bg-white focus:bg-opacity-50 focus:outline-none focus:ring focus:ring-white sm:h-8 sm:w-8 md:text-xl lg:h-9 lg:w-9 2xl:h-11 2xl:w-11 ${
