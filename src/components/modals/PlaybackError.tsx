...
const PlaybackError = ({
  ...
  return (
    ...
    >
      {isDetailModal ? (
        <div className="flex items-center justify-center rounded bg-zinc-900 px-[0.65rem] py-2 text-white">
          <svg
        ...
        <div className="flex items-center justify-center rounded bg-zinc-900 px-[0.6rem] py-[0.45rem] text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
