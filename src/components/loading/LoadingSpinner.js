  ...
  return activeProfile ? (
    ...
    >
      ...
      <img
        ...
        className="absolute h-[10.5rem] w-[10.5rem] fill-netflix-red text-netflix-red motion-safe:animate-spin"
      />
    </motion.div>
  ) : (
    <motion.div
    ...
    >
      <img
        src={loadingSpinnerURL}
        className="absolute h-24 w-24 fill-netflix-red text-netflix-red motion-safe:animate-spin"
      />
    </motion.div>
  );
};
