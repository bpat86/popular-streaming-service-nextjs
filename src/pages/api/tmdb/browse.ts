  ...
  async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    if (req.method === "GET") {
      ...
      const results = await Promise.allSettled([
        ...
        axios.get(makeMediaURL(upcomingMoviesUrl, "1")),
        axios.get(makeMediaURL(upcomingMoviesUrl, "2")),
        axios.get(makeMediaURL(upcomingMoviesUrl, "3")),
      ...
      try {
        // All at once... liekly not the best approach, however it is the fastest?
        const [
          getUserMe,
