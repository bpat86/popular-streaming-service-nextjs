  ...
  return (
    <span className="media-control-buttons">
      ...
      >
        <button
          type="button"
          className={`flex items-center justify-center border-2 border-white border-opacity-50 hover:border-opacity-100 focus:border-opacity-100 rounded-full text-white bg-transparent hover:bg-white focus:bg-white hover:bg-opacity-50 focus:bg-opacity-50 focus:ring-inset focus:ring-2 focus:ring-white focus:outline-none font-bold md:text-xl w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 mx-1 transition ease-out duration-150 relative ${
