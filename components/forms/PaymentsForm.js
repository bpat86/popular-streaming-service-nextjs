...
export const PaymentsForm = (props) => {
  ...
  return (
    <>
      <div className="flex flex-row items-center text-sm text-gray-800 ml-auto my-1">
        Secure Server{" "}
        <svg
        ...
        {({ isSubmitting }) => (
          <Form className="w-full">
            {isSubmitting || stripeLoading || !stripe || !elements ? (
              <button
                type="submit"
                className="w-full flex flex-row items-center py-3 px-4 pr-2 h-16 rounded-md text-base font-semibold tracking-wide text-gray-700 bg-white border-2 border-gray-400 focus:outline-none transition ease-out duration-700"
              >
                <span className="ml-auto">Processing</span>
                {/* Spinner */}
                <svg
                  className="motion-safe:animate-spin ml-2 h-5 w-5 text-gray-500"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="text-gray-400 h-7 w-7 ml-auto"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <button
                ...
                type="submit"
                className="w-full flex flex-row items-center py-3 px-4 pr-2 h-16 rounded-md text-base font-semibold tracking-wide text-gray-700 bg-white border-2 border-gray-300 hover:border-gray-400 focus:outline-none transition ease-out duration-700"
              >
                <span>Credit or Debit Card</span>
                <span className="flex flex-row space-x-2">
                  <img
                    className="w-auto h-5 sm:h-6 ml-3"
