    ...
    <>
              ...
              <div className="pt-5 pb-6 px-5">
                <div className="flex items-center justify-between">
                  <div>
                    {/* Logo */}
                    <svg
                      className="h-6 w-auto sm:h-8 text-indigo-600"
                  ...
                  <div className="-mr-2">
                    <button
                      type="button"
                      className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600"
              ...
              <div className="py-6 px-5">
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-6 text-center text-base font-medium text-gray-500">
                    ...
                    <a
                      href="#"
                      className="text-indigo-600 hover:text-indigo-600 ml-2"
                    >
                      Sign in
                    </a>
                  </p>
      ...
      <Transition show={isOpen}>
        {(ref) => (
          <div
            ref={ref}
            className="click-overlay transition ease-in-out duration-150"
            onClick={() => setIsOpen(!isOpen)}
          ></div>
        )}
      </Transition>
