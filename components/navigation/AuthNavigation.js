...
export const AuthNavigation = (props) => {
  ...
  return (
    <>
      {
        <header className="navigation relative w-full z-10">
          <div
            ref={header}
            className="navigation-content w-full absolute overflow-hidden z-10"
          >
            <div className="navbar bg-white bg-opacity-90 relative py-4 z-20 border-b border-gray-200 backdrop-filter backdrop-blur-sm">
              {/* Container */}
              <div className="flex justify-between items-center max-w-screen-3xl mx-auto px-6 py-2 sm:px-12 md:justify-start md:space-x-10">
                <div className="flex justify-start lg:w-0 lg:flex-1">
                  <Link href="/">
                    <a>
                      <Logo
                        className={`h-12 sm:h-12 w-auto text-netflix-red`}
                      />
                    </a>
                  </Link>
                </div>
                  ...
                  {isLoggedIn ? (
                    <>
                      <button
                        type="submit"
                        onClick={() => logout()}
                        className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-5 py-1 border border-transparent rounded text-lg font-semibold text-gray-800 focus:outline-none transition ease-out duration-700"
                      >
                        Sign Out
                      </button>
                    </>
                    ...
                    <>
                      <Link href="/login">
                        <a className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-5 py-1 border border-transparent rounded text-lg font-semibold text-gray-800  focus:outline-none transition ease-out duration-700">
                          Sign In
                        </a>
                      </Link>
                    </>
