      ...
      {selectAvatarPrompt ? (
        ...
        <Profile {...profileContextProps}>
          <div className="fixed inset-0 overflow-y-scroll sm:overflow-hidden">
            <div className="sm:fixed sm:inset-0 flex flex-col items-center justify-start sm:justify-center w-full min-h-full sm:h-screen mt-20 mb-0 sm:my-0 fade-in">
              <Formik
                  ...
                  <Form className="block w-full lg:w-3/4 xl:w-2/5 mx-auto px-6">
                    ...
                    <div className="flex my-4 mt-8 sm:mt-12 space-x-3 sm:space-x-6">
                      <button
                        ...
                        type="submit"
                        className="flex items-center bg-white hover:bg-netflix-red focus:bg-netflix-red text-gray-900 hover:text-white focus:text-white text-xs sm:text-2xl font-bold uppercase tracking-widest focus:outline-none px-3 sm:px-6 py-2"
                      >
                        {isSubmitting ? (
                          <>
                            Processing
                      ...
                      <button
                        type="reset"
                        className="bg-transparent border border-gray-400 hover:border-white focus:border-white text-gray-400 hover:text-white focus:text-white text-xs sm:text-2xl font-bold uppercase tracking-widest focus:outline-none px-3 sm:px-6 py-2"
                      >
                        Cancel
                      </button>
                      <button
                        type="button"
                        className="sm:w-full bg-transparent border border-gray-400 hover:border-white focus:border-white text-gray-400 hover:text-white focus:text-white text-xs sm:text-2xl font-bold uppercase tracking-widest focus:outline-none px-3 sm:px-6 py-2"
