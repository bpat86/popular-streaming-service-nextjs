      ...
      <RegistrationLayout title="Sign up for Netflix" {...props}>
        <div className="max-w-4xl mx-auto slide-in">
          <div className="flex flex-col items-start max-w-4xl mx-auto">
            ...
            <p className="block text-gray-800 text-2xl sm:text-3xl font-bold text-center tracking-wide">
              Choose your plan
            </p>
          ...
          {/* Mobile */}
          <div className="block sm:hidden max-w-2xl mx-auto space-y-16 mt-16 lg:hidden">
            <section className="group">
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr className="border-t border-gray-200">
                    <th
                      className="py-5 px-4 text-base font-medium text-gray-900 text-left"
                      scope="row"
                    >
                      Video quality
                    </th>
                    <td className="py-5 pr-4">
                      <span className="block text-base font-bold text-gray-700 group-hover:text-netflix-red text-right">
                        Good
                      </span>
                    </td>
                  </tr>
              ...
              <div className="border-t border-gray-200 px-4 pt-5">
                <a
                  href="#"
                  className="block w-full bg-netflix-red border border-netflix-red rounded-sm py-3 text-base font-medium tracking-wider text-white text-center hover:bg-netflix-red-light"
                >
                  Get Basic
                </a>
              </div>
          ...
          <div className="hidden sm:block lg:-mx-5">
            <table className="plans w-full h-px table-fixed">
              <caption className="sr-only">Pricing plan comparison</caption>
              <thead>
                <tr className="relative">
                  <th
                    className="pb-4 px-6 text-base font-medium text-gray-900 text-left"
                    scope="col"
                  >
                  ...
                  {stripeSubscriptionPlans
                    ...
                    .map((plan, idx) => (
                      <th
                        ...
                        className="w-full sm:w-1/5 pb-4 px-6 text-lg leading-6 font-medium text-center"
                        scope="col"
                      >
                        <label
                          className={`w-32 h-32 relative flex items-center justify-center rounded-sm focus:outline-none  mx-auto px-6 py-4 cursor-pointer select-none ${
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="relative">
                  <th
                    className="w-full py-8 px-6 text-base font-medium text-gray-900 text-left"
                    scope="row"
                  >
                    Monthly price
                  </th>
                ...
                <tr className="relative">
                  <th
                    className="py-5 px-6 text-base font-medium text-gray-900 text-left"
                    scope="row"
                  >
                    Video quality
                  </th>
          ...
          <div className="px-6 mt-10 w-full sm:w-5/6 lg:-mx-5">
            <span className="block w-full text-sm text-gray-500 leading-snug">
              HD (720p), Full HD (1080p), Ultra HD (4K) and HDR availability
              subject to your internet service and device capabilities. Not all
              content is available in all resolutions. See our Terms of Use for
              more details.
            </span>
            <span className="block w-full text-sm text-gray-500 leading-snug mt-4">
