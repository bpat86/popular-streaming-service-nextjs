...
import ProfilesAccordion from "@/components/my-account/ProfilesAccordion";
...
const Index = (props) => {
  ...
  const DisplaySubscription = () => {
    ...
    if (plan && plan === "Premium") {
      return (
        <span className="flex items-center flex-row space-x-1 text-base text-gray-700">
          <span>{plan}</span>
          <span>
            <svg className="h-5 ml-3" viewBox="0 0 4770 960">
      ...
      <div className="flex flex-col space-y-1">
        {user?.paymentMethods?.data?.map((method) => (
          <div key={method.id} className="group flex items-center">
            <span className="flex items-center flex-row w-full px-3 py-3 space-x-2 hover:bg-gray-50 text-gray-700 rounded-lg cursor-pointer">
              <img
            ...
            <div className="flex-shrink-0 ml-1">
              <button
                type="button"
                className="inline-flex items-center p-1 border border-transparent rounded-full group-hover:bg-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 ease-out duration-200 focus:ring-gray-600"
              >
    ...
    <Elements stripe={stripePromise}>
      <AccountLayout {...data}>
        <div className="flex items-center">
          <h2 className="text-4xl leading-6 text-gray-800 tracking-wide">
            Account
          </h2>
          <div className="account member-since flex items-center text-sm font-semibold tracking-wide ml-4">
        ...
        <div className="mt-5 border-t-2 border-gray-200">
          <div className="divide-y-2 divide-gray-200 text-sm sm:text-base text-gray-500">
            <section className="w-full mt-6">
              <div className="flex items-center">
                <span className="text-gray-600 text-lg sm:text-xl tracking-wide">
                  Membership & Billing
                </span>
                {isActive ? (
                  <span className="inline-flex items-center ml-3 px-3 py-0.5 rounded-full text-sm font-normal tracking-wide bg-green-100 text-green-800">
                    Active
                  </span>
                ) : (
                  <span className="inline-flex items-center ml-3 px-3 py-0.5 rounded-full text-sm font-normal tracking-wide bg-red-100 text-red-800">
                    Inactive
                  </span>
                )}
              </div>
              <div className="divide-y divide-gray-200">
                <section className="grid lg:grid-cols-3 gap-6 lg:gap-8 py-6 sm:py-8">
                  <div className="space-y-1 sm:space-y-2">
                    <h2 className="text-base sm:text-lg text-gray-600 font-semibold">
                      Email address
                    </h2>
                    <p className="text-sm sm:text-base leading-snug sm:leading-tight">
                ...
                <section className="grid lg:grid-cols-3 gap-6 lg:gap-8 py-6 sm:py-8">
                  ...
                  <div className="account-password flex items-center w-full flex-grow sm:col-span-2">
                ...
                <section className="grid lg:grid-cols-3 gap-6 lg:gap-8 py-6 sm:py-8">
                  ...
                  <div className="flex items-start w-full flex-grow font-bold tracking-wide sm:col-span-2">
                    <PaymentMethodsList />
                  </div>
                  <div className="space-y-1 sm:space-y-2">
                    <h2 className="text-base sm:text-lg text-gray-600 font-semibold">
            ...
            <section className="grid lg:grid-cols-3 gap-6 lg:gap-8 py-6 sm:py-8">
              ...
              <div className="flex sm:col-span-2">
                <span className="account-plan flex items-center w-full flex-grow font-bold">
                  <DisplaySubscription mutateUser={mutateUser} />
                </span>
                <span className="ml-4 flex-shrink-0">
                  <button
                    type="button"
                    className="bg-white rounded text-blue-600 hover:text-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 my-2 sm:my-1"
                  >
                    Change plan
                  </button>
                </span>
            ...
            <section className="grid lg:grid-cols-3 gap-6 lg:gap-8 py-6 sm:py-8">
              ...
              <div className="flex flex-col w-full text-gray-700 col-span-2">
                {profiles?.map((profile, idx) => (
                  ...
                  >
                    <div className="sm:grid sm:grid-cols-2 sm:gap-4 ml-20 my-4">
                      <div className="flex items-center sm:col-span-2">
                        <span className="account-plan flex flex-col w-full flex-grow">
                        ...
                        <span className="ml-4 flex-shrink-0">
                          <button
                            type="button"
                            className="bg-white rounded text-sm text-blue-600 hover:text-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 my-2 sm:my-1"
                          >
                            Change
                          </button>
                        </span>
...
export const getServerSideProps = withSessionSsr(async ({ req, res }) => {
  ...
  let isActive = subscriptions.data[0].status === "active" ? true : false;
